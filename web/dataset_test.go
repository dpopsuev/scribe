...
func seedDataset(t *testing.T, s parchment.Store) *parchment.Protocol {
	...
	arts := []*parchment.Artifact{
		{ID: "TASK-001", Labels: []string{"kind:effort.task", "work.active", "project:alpha"}, Title: "Build export"},
		{ID: "TASK-002", Labels: []string{"kind:effort.task", "work.draft", "project:alpha"}, Title: "Draft task — excluded"},
		{ID: "ADR-001", Labels: []string{"kind:intent.decision", "decision.accepted", "project:alpha"}, Title: "Use JSONL",
		...
		{ID: "SPEC-001", Labels: []string{"kind:intent.spec", "work.active", "project:alpha"}, Title: "Dataset API",
			Sections: []parchment.Section{
...
func TestDatasetExport_QualityFilter_ExcludesViolation(t *testing.T) {
	...
	_ = s.Put(ctx, &parchment.Artifact{
		...
		Labels: []string{"kind:effort.task", "work.active", "compliance:violation", "project:x"},
	})
	_ = s.Put(ctx, &parchment.Artifact{Labels: []string{"kind:effort.task", "work.active", "project:x"}, ID: "GOOD-001", Title: "Good"})
