...
type artifactInput struct {
	Action string `json:"action" jsonschema:"required,create get query set update delete attach detach recent brief schema help kernel_create kernel_confirm kernel_reject export claim release handoff comment_add comment_list librarian message_add message_list cursor_mark cursor_get librarian_pass"`
