...
type artifactInput struct {
	Action string `json:"action" jsonschema:"required,create | get | query | set | update | link | lint | synthesize | schema | history | delete | hygiene | dashboard | recent | brief | analyze"`
