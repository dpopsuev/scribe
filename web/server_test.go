...
func setup(t *testing.T) *web.Server {
	...
	s.Put(ctx, &parchment.Artifact{
		Labels: []string{"kind:effort.task", "work.active", "project:test"}, ID: "TASK-2026-001", Title: "Test Task",
		Sections: []parchment.Section{
			{Name: "design", Text: "## Overview\n\nThis is a **test** design."},
		},
	})
	s.Put(ctx, &parchment.Artifact{Labels: []string{"kind:effort.campaign", "work.active", "project:test"}, ID: "CMP-2026-001", Title: "Test Campaign"})
	s.Put(ctx, &parchment.Artifact{Labels: []string{"kind:effort.goal", "work.active", "project:test"}, ID: "GOL-2026-001", Title: "Test Goal"})
	s.Put(ctx, &parchment.Artifact{Labels: []string{"kind:effort.task", "work.active", "project:test"}, ID: "TASK-2026-002", Title: "Child Task"})
